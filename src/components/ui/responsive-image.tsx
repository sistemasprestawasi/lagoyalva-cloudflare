...
export function ResponsiveImage({
  ...
  if (!fill && aspectRatio !== "auto") {
    ...
    else if (aspectRatio === "video") paddingBottom = "56.25%"; // 16:9
    else if (aspectRatio === "portrait") paddingBottom = "150%"; // 2:3
    else if (aspectRatio === "wide") paddingBottom = "42.85%"; // 21:9
  ...
  return (
    ...
    >
      ...
      >
        <Image
          {...imageProps}
          alt={imageProps.alt ?? ""} // ✅ Solución ESLint
          className={cn(
